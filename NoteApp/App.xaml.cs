...
using NoteApp.Core.Commands;
using NoteApp.Core.Win32Api;
using NoteApp.Modules.Note;
using NoteApp.Modules.Notebook;
using NoteApp.Modules.Notes;
using NoteApp.Modules.Settings;
    ...
    public partial class App
    {
        ...
        private static void ConfigureLogging()
        {
            ...
            Log.Logger = new LoggerConfiguration()
               .WriteTo.File(Path.Combine(_logsPath, "NoteApp-.log"),
        ...
        private void LogFatalAndExit(Exception ex)
        {
            ...
            MessageBox.Show(errorMessage, "NoteApp - Fatal Error", MessageBoxButton.OK, MessageBoxImage.Error);
